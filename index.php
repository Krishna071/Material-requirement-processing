...
<body>
  <img src="bg.jpg" alt="factory" style= "width:99%; height: 100%; position: absolute; z-index:-1; opacity: 0.7">
   <!-- <?php include('navbar.php'); ?>  -->
   <nav class="Nav">
    <ul>
    <li>
    <a href="loginUser.php">User Sign In</a>
    </li>
    <li>
    <a href="loginAdmin.php">Admin Sign In</a>
    </li>
    <li>
    </ul>
   </nav>
