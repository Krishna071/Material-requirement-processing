...
<body>
<img src="bg.jpg" alt="factory" style= "width:100%; height: 99%; position: absolute; z-index:-1; opacity: 0.9">
...
<div class = 'moneyTransfer'>
    ...
    <form name="myForm" action="ResultPage.php"  onsubmit="return validateForm()" method="post">
        ...
        <tr>
            <td><input type= "hidden" name= "form_submituser" value="1"></td>
    ...
    <form name="myForm" action="ResultPage.php"  onsubmit="return validateForm()" method="post">
        ...
        <tr>
            <td><input type= "hidden" name= "form_sub" value="1"></td>
